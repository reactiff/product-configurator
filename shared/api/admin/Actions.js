...
const actions = {
    ...
    announcement: {
        ...
        publish: {
            action: (announcement) => api.action(announcement, 'publish'),
            title: (announcement) => 'This announcement has not been published',
            condition: (announcement) => !announcement.published
        },

        unpublish: {
            condition: (announcement) => announcement.published,
            title: (announcement) => 'This announcement is LIVE',
            action: (announcement) => api.action(announcement, 'unpublish'),
        }
    ...
    classpackage: { 
        ...
        updateSchedule: {
            action: (pkg) => api.action(pkg, 'updateSchedule')
        }
